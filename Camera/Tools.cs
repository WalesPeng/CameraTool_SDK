...
namespace LeopardCamera
{
    public class Tools
    {
        ...
        public static Bitmap ConvertBayer2BMP(IntPtr ptr, int iInWidth, int iHeight, int iBits, int pixelOrder, double gamma, bool Mono, bool Dual)
        {
        ...
        // YKB 20180424 add 
        public static Bitmap ConvrtYUV422BMP_YKB(IntPtr ptr, int iInWidth, int iHeight, Bitmap bmp, bool mark_en, int offset, int topleft, int bottomleft, int topright, int bottomright)
        {
            BitmapData bmpData = bmp.LockBits(new Rectangle(0, 0, bmp.Width, bmp.Height),
                                        ImageLockMode.WriteOnly, bmp.PixelFormat);
            IntPtr rgb = bmpData.Scan0;
